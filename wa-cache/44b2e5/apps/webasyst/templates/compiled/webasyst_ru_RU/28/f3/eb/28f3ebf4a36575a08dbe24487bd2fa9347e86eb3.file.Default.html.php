<?php /* Smarty version Smarty-3.1.14, created on 2022-03-31 00:43:51
         compiled from "/home/miricouz/xx.uz/wa-widgets/news/templates/Default.html" */ ?>
<?php /*%%SmartyHeaderCode:2812832636244b2f71273f9-68980512%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '28f3ebf4a36575a08dbe24487bd2fa9347e86eb3' => 
    array (
      0 => '/home/miricouz/xx.uz/wa-widgets/news/templates/Default.html',
      1 => 1637749369,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2812832636244b2f71273f9-68980512',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_6244b2f717ccd7_56713427',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_6244b2f717ccd7_56713427')) {function content_6244b2f717ccd7_56713427($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_wa_datetime')) include '/home/miricouz/xx.uz/wa-system/vendors/smarty-plugins/modifier.wa_datetime.php';
?>
<?php if ($_smarty_tpl->tpl_vars['ui']->value=='2.0'){?>
    ...
    .wa-news-widget::before { content: ''; position: absolute; bottom: 0; left: 0; right: 0; height: 40px; background: linear-gradient(to bottom, var(--dashboard-widget-fade-background-start) 0%, var(--dashboard-widget-fade-background-end) 100%); }
    .wa-news-widget::after { content: ''; position: absolute; top: 0; left: 0; right: 0; height: 20px; background: linear-gradient(to top, var(--dashboard-widget-fade-background-start) 0%, var(--dashboard-widget-fade-background-end) 50%); }
    ...
    .widget-block .wa-news-widget .wa-link-to-all-news { position: absolute; bottom: 0; left: 0; right: 0; opacity: 1; height: 42px; background: var(--dashboard-widget-background-color); box-shadow: inset 0px 1px 0px rgba(0, 0, 0, 0.1); display: flex; justify-content: center; align-items: center; transition: transform 0.3s ease-in-out; transform: translateY(43px)}

    .widget-block:hover .wa-news-widget .wa-link-to-all-news { opacity: 1; transform: translateY(0)}
