<?php /* Smarty version Smarty-3.1.14, created on 2022-03-31 00:46:24
         compiled from "/home/miricouz/xx.uz/wa-apps/installer/templates/helper/product_review_widget.html" */ ?>
<?php /*%%SmartyHeaderCode:4880990646244b390577d30-82848160%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'aa6acb1309408370b63354f3c0b1bcfae59fa50d' => 
    array (
      0 => '/home/miricouz/xx.uz/wa-apps/installer/templates/helper/product_review_widget.html',
      1 => 1634815044,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '4880990646244b390577d30-82848160',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_6244b3906022b4_13434993',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_6244b3906022b4_13434993')) {function content_6244b3906022b4_13434993($_smarty_tpl) {?><?php $_smarty_tpl->tpl_vars['wrapper_class_id'] = new Smarty_variable('i-product-review-widget-wrappper', null, 0);?>
...
wa-apps/installer/css/app.installer<?php if ($_smarty_tpl->tpl_vars['wa']->value->whichUI()==='1.3'){?>-legacy<?php }?>.css?v=<?php echo $_smarty_tpl->tpl_vars['wa']->value->version();?>
" rel="stylesheet">
...
dialog-header<?php if ($_smarty_tpl->tpl_vars['wa']->value->whichUI()!=='1.3'){?> flexbox<?php }?>">
            <h1 class="js-content-title<?php if ($_smarty_tpl->tpl_vars['wa']->value->whichUI()!=='1.3'){?> wide<?php }?>"><?php echo _wd('installer','Your review');?>
</h1>
            <?php if ($_smarty_tpl->tpl_vars['wa']->value->whichUI()!=='1.3'){?>
...
,
                    ...
                    ui: <?php echo json_encode($_smarty_tpl->tpl_vars['wa']->value->whichUi());?>
